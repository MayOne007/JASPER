...
public class SpringJunitTest {
	...
	class TestUncaughtExcuptionHandler implements Thread.UncaughtExceptionHandler {
    ...
    class TestThreadFactory implements ThreadFactory {
        ...
        public Thread newThread(Runnable r) {
        	...
        	t.setUncaughtExceptionHandler(new TestUncaughtExcuptionHandler());                   
            return t;
        }
    }*/
	...
	public void test() throws SQLException {
		...
		try {
			...
			JasperPrint jasperPrint = JasperFillManager.fillReport(reportPath, map,dataSource.getConnection());
			// 4.设定目标文件输出的路径
